...
async function analyseAvecIA(text, rel) {
  try {
    ...
    const prompt =
            ...
            " DEUX ERREURS RÉELLES DÉJÀ COMMISES, à ne surtout plus refaire : " +
            ...
            " Si un message te rappelle l'un de ces deux cas, ou si tu hésites entre signaler et ne rien signaler : NE SIGNALE RIEN. " +
